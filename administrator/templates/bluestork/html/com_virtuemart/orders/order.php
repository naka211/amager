...
//Edit
$servicePointId = $this->orderdetails['details']['BT']->shop_id;
$address_2 = $this->orderdetails['details']['BT']->address_2;
$tmp = explode('-', $address_2);
$company = trim($tmp[0]);

$tmp = explode(',', trim($tmp[1])); 
$tmp1 = explode(' ', trim($tmp[0]));
$streetNumber = trim($tmp1[0]);
$streetName = '';
	...
	<tr>
		...
		<table class="adminlist" width="100%">
			...
			?>
                ...
                <?php include 'smartsend-version5.php'; ?>
		</td>
	</tr>
</table>
