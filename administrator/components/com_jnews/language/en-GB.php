...
define('_JNEWS_MENU_DEL_QUEUE' , 'Delete');
...
define('_JNEWS_SUB_INFO', 'Subscriber\'s information');
...
define('_JNEWS_RECEIVE_HTML', 'Receive HTML?');
...
define('_JNEWS_ACCOUNT_CONFIRMED', 'Your account has been activated.');
...
define('_JNEWS_SUBSCRIPTIONS', 'Your Subscription');
...
define('_JNEWS_SUBSCRIBE_SUBJECT_MESS', 'Please confirm your subscription');
define('_JNEWS_UNSUBSCRIBE_SUBJECT_MESS', 'Unsubscription confirmation');
define('_JNEWS_DEFAULT_SUBSCRIBE_MESS', 'Hi {tag:name},<br /><br />' .
...
define('_JNEWS_DEFAULT_UNSUBSCRIBE_MESS', 'This is a confirmation email that you have been unsubscribed from our list.  We are sorry that you decided to unsubscribe. But if you decide to re-subscribe you can always do so on our site.  Should you have any question please contact our webmaster.');
define('_JNEWS_HELLO', 'Hello ');
...
define('_JNEWS_COMFIRM_SUBSCRIPTION', 'A confirmation email has been sent to you.  Please check your email and click on the link provided.<br />' .
		'You need to confirm your email for your subscription to take effect.');
define('_JNEWS_SUCCESS_ADD_LIST', 'You have been successfully added to the list.');


 // Subcription info
define('_JNEWS_CONFIRM_LINK', 'Click here to confirm your subscription');
define('_JNEWS_UNSUBSCRIBE_LINK', 'Click here to unsubscribe yourself from the list');
define('_JNEWS_UNSUBSCRIBE_MESS', 'Your email address has been removed from the list');
...
define('_JNEWS_UNSUBSCRIBE_MESSAGE', 'Are you sure you want to unsubscribe from this list?');
define('_JNEWS_MOD_SUBSCRIBE', 'Subscribe');
define('_JNEWS_SUBSCRIBE', 'Subscribe');
define('_JNEWS_UNSUBSCRIBE', 'Unsubscribe');
define('_JNEWS_VIEW_ARCHIVE', 'Archive');
define('_JNEWS_SUBSCRIPTION_OR', 'Click here to update your information');
define('_JNEWS_EMAIL_ALREADY_REGISTERED', 'This email address has already been registered.');
...
define('_JNEWS_LIST_T_SENDER', 'Sender');
...
define('_JNEWS_LIST_SENDER', 'List Owner');
...
define('_JNEWS_NOT_PUBLISHED', 'Could not send the mailing, the list is not published.');
...
define('_JNEWS_CHANGE_SUBSCRIPTIONS', 'Change');
define('_JNEWS_CHANGE_EMAIL_SUBSCRIPTION', 'Change your subscription');
...
// mail settings
define('_JNEWS_SEND_MAIL_FROM', 'Bounce Back Email<br/>(used as Bounced back for all your messages)');
...
//
define('_JNEWS_UNSUB_MESSAGE', 'Unsubscribe Email');
define('_JNEWS_UNSUB_SETTINGS', 'Unsubscribe Settings');
...
define('_JNEWS_IMPORT_TIPS','Import subscribers. The information in the file need to be to the following format: ' .
...
define('_JNEWS_SUBCRIBERS_VIEW', 'Subscribers');
...
define('_JNEWS_INPUT_NAME_TIPS', 'Enter your full name (firstname first)');
define('_JNEWS_IP_TIPS', 'IP of the subscriber' );
define('_JNEWS_INPUT_EMAIL_TIPS', 'Enter your email address (Make sure this is a valid email address if you want to receive our mailings.)');
define('_JNEWS_RECEIVE_HTML_TIPS', 'Choose Yes if you want to receive HTML mailings - No to receive Text only mailings');
...
define('_JNEWS_CONTENT_ORDERING' , 'Content Ordering');
define('_JNEWS_CONTENT_ORDERING_TIPS' , 'This will sort the contents in your content plugin');
...
define('_JNEWS_UNSUBSCRIBE_ADMIN_NOTIFICATION', '<p>Dear [LISTOWNERNAME],<br /> <br /></p>
<p style="padding-left: 30px;">This is an automated message from [SITE]. To inform you that a user unsubscribed to your newsletter list.</p>
<p style="padding-left: 60px;"><strong>Details</strong></p>
<p style="padding-left: 60px;">Date and Time of Unsubscription: <strong>{tag:date}</strong><br />Subscriber Name: <strong>[SUBSCRIBERNAME]</strong><br />Subscriber Email: <strong>[SUBSCRIBEREMAIL]</strong></p>
<p style="padding-left: 60px;">Unsubscribed List: <strong>[LISTID] - [LISTNAME]</strong></p>
...
define('_JNEWS_TAG_ARTICLECATEGORY' , 'Categories');
...
define('_JNEWS_NOSMARTTAG', 'The Smart Newsletter doesn\'t contain a [SMARTNEWSLETTER] tag yet. Please insert the tag in the content.');
...
define('_JNEWS_ALLOW_SN', 'Allow FE Smart-Newsletter');
define('_JNEWS_ALLOW_SN_TIP', 'Allow creation of Smart-Newsletter in the front-end.');
...
define('_JNEWS_RED_SUBS_TIP', 'Redirect page after subscription from the module to jNews page.');
...
define('_JNEWS_VIEW_BROWSER', 'Preview in the Browser');
...
define('_JNEWS_CRON_TRIGGERRED_TIPS', 'This date indicate the last time the cron URL was triggered. It does not mean the cron was launched at that time, it only indicate something triggered the URL.');
...
define('_JNEWS_SEND_LOG_TO_TIPS', 'Send mailing reports to this email. If none is specified the mailing report will be sent to the first admin of the site. To specify several emails simply seperate them by a comma (,).');
