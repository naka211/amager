...
?>
            ...
            <div class="w-print-down">            
                <div class="bnt-download">
                   <a href="javascript:location.href = '<?php echo 'index.php?option=com_virtuemart&view=invoice&layout=invoice&format=pdf&tmpl=component&virtuemart_order_id='.$row->virtuemart_order_id.'&order_number='.$orderDetails['details']['BT']->order_number.'&order_pass='.$orderDetails['details']['BT']->order_pass;?>'">Download PDF-file</a>
                </div><!--.bnt-download-->
