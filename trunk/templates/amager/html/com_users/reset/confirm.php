...
<div class="reset-confirm<?php echo $this->pageclass_sfx?>" id="w-newsletter">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=reset.confirm'); ?>" method="post" class="form-validate newsletter-content">
