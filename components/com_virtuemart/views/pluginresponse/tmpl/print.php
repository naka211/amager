...
$db->setQuery($query);
$order_info = $db->loadObject();//print_r($order_info);exit;
...
<body style="padding: 0; margin: 0px; background: #cacaca; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; font-size: 13px;" onLoad="window.print();">
  ...
  <tr height="30">
    ...
    <td width="305"><strong><?php echo $order_info->order_number;?></strong></td>
  </tr>
  <tr height="30">
  ...
  <tr height="30">
    ...
    <td width="305"><strong><?php echo $email;?></strong></td>
  </tr>
  <tr height="30">
  	<td colspan="2">
   	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <?php if($BT_info->address_type_name == 2){?>
             <tr>
                ...
                <td width="50%" height="30"><?php echo $BT_info->company;?></td>
              </tr>
               <tr>
                <td width="50%" height="30">CVR-nr.:</td>
                <td width="50%" height="30"><?php echo $BT_info->cvr;?></td>
              </tr>
            <?php } else if($BT_info->address_type_name == 3){?>
            <tr>
                <td width="50%" height="30">EAN-nr.:</td>
                <td width="50%" height="30"><?php echo $BT_info->ean;?></td>
              </tr>
               <tr>
                <td width="50%" height="30">Myndighed/Institution:</td>
                <td width="50%" height="30"><?php echo $BT_info->authority;?></td>
              </tr>
              <tr>
                <td width="50%" height="30">Ordre- el. rekvisitionsnr.:</td>
                <td width="50%" height="30"><?php echo $BT_info->order1;?></td>
              </tr>
               <tr>
                <td width="50%" height="30">Personreference:</td>
                <td width="50%" height="30"><?php echo $BT_info->person;?></td>
              </tr>
            <?php }?>
          <tr>
            <td width="50%" height="30">Fornavn:</td>
            <td width="50%" height="30"><?php echo $BT_info->first_name;?></td>
          </tr>
          <tr>
            <td height="30">Efternavn:</td>
            <td height="30"><?php echo $BT_info->last_name;?></td>
          </tr>
          <tr>
            <td height="30">Adresse:</td>
            <td height="30"><?php echo $BT_info->address_1;?></td>
          </tr>
          <tr>
            <td height="30">Postnr.:</td>
            <td height="30"><?php echo $BT_info->zip;?></td>
          </tr>
          <tr>
            <td height="30">By:</td>
            <td height="30"><?php echo $BT_info->city;?></td>
          </tr>
          <tr>
            <td height="30">Telefon:</td>
            <td height="30"><?php echo $BT_info->phone_1;?></td>
          </tr>
        </table>
    ...
    <td colspan="2" width="558" valign="top">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="50%" height="30">Fornavn:</td>
            <td width="50%" height="30"><?php echo $ST_info->first_name;?></td>
          </tr>
          <tr>
            <td height="30">Efternavn:</td>
            <td height="30"><?php echo $ST_info->last_name;?></td>
          </tr>
          <tr>
            <td height="30">Adresse:</td>
            <td height="30"><?php echo $ST_info->address_1;?></td>
          </tr>
          <tr>
            <td height="30">Postnr.:</td>
            <td height="30"><?php echo $ST_info->zip;?></td>
          </tr>
          <tr>
            <td height="30">By:</td>
            <td height="30"><?php echo $ST_info->city;?></td>
          </tr>
          <tr>
            <td height="30">Telefon:</td>
            <td height="30"><?php echo $ST_info->phone_1;?></td>
          </tr>
        </table>
  ...
  <tr>
    <td valign="top" height="30"><?php if($BT_info->address_2){?>Afhentning: <?php echo $BT_info->address_2;?><?php }else{?>Forsendelse<?php }?></td>
  </tr>
</table>
  ...
  <tr height="30" style="padding: 0 10px;">
    <td style="text-transform: uppercase; color: red; padding: 0 10px; font-size: 20px;"><strong><?php if($BT_info->address_2){?>Afhentning: <?php echo $BT_info->address_2;?><?php }else{?>Forsendelse<?php }?></strong></td>
    ...
    <td colspan="2"><table width="136" border="0" cellpadding="0" cellspacing="0" align="right" style="text-align: right;" >
      <tr height="30" style="padding: 0 10px;">
        <td width="146" style="padding: 0 10px; color: #3A3A3A;"><?php echo number_format($order_info->order_shipment,2,',','.');?> DKK</td>
      </tr>
      <tr height="30" style="padding: 0 10px;">
